...
class Global
{
    ...
    public static void Inizializza(Giocatore player)
    {
        ...
        // ====================================================================
        // Le porte collegano le stanze secondo il tuo schema
        // Tutti i corridoi hanno porte aperte tra loro (sono divisioni logiche)
        // Le stanze vere hanno porte specifiche come indicato

        // Porta: PORTO -> MAGAZZINO (Nord da Porto, Sud da Magazzino)
        ...
        // Porta: MAGAZZINO -> SALA MOTORI EST (OVEST) (Est da Magazzino, Ovest da Motori Est 1)
        ...
        // Porta: SALA MOTORI EST (OVEST) -> SALA OSSIGENO (Nord da MotoriEst1, Sud da Ossigeno)
        ...
        // Porta: SALA MOTORI EST (EST) -> CORRIDOIO EST (SUD) (Est da MotoriEst2, Ovest da CorrEstS) 
        ...
        // Porta: CORRIDOIO EST (NORD) -> ARCHIVIO (Ovest da CorrEstN, Est da Archivio)
        ...
        // Porta: ARCHIVIO -> CORRIDOIO CENTRALE (NORD) (Ovest da Archivio, Est da CorrCentraleN)
        ...
        // Porta: CORRIDOIO CENTRALE NORD -> SALA COMANDI (Nord da CorrCentraleN, Sud da SalaComandi)
        ...
        // Porta: CORRIDOIO CENTRALE NORD -> RIPOSTIGLIO (Ovest da CorrCentraleN, Est da Ripostiglio)
        ...
        // Porta: RIPOSTIGLIO -> CORRIDOIO OVEST (NORD) (Ovest da Ripostiglio, Est da CorrOvestN)
        ...
        // Porta: CORRIDOIO OVEST (NORD) -> CORRIDOIO OVEST (SUD) (Sud da CorrOvestN, Nord da CorrOvestS)
        ...
        // Porta: CORRIDOIO OVEST (SUD) -> SALA MEDICA (Est da CorrOvestS, Ovest da SalaMedica)
        ...
        // Sala Medica <-> Corridoio Centrale Sud
        ...
        // Sala Ossigeno <-> Corridoio Centrale Sud
        ...
        // Motori Est 1 <-> Motori Est 2 (interni della stanza motori)
        ...
        // Magazzino <-> Motori Ovest 2 (Ovest da Magazzino, Est da MotoriOvest2)
        Porta portaMagazzinoMotoriO2 = new Porta("Porta Magazzino-MotoriOvest2", Porta.StatoPorta.Aperta);
        magazzino.portaOvest = portaMagazzinoMotoriO2;
        motoriOvest2.portaEst = portaMagazzinoMotoriO2;

        // Motori Ovest 1 <-> Motori Ovest 2
